...
import { Wallet, Eye, EyeOff, ArrowRight, AlertCircle, Shield, Zap, Globe, Lock } from 'lucide-react';
...
const Login = () => {
  ...
  const handleAppleLogin = () => {
    // Apple login not implemented with Supabase yet
    setError('Apple login is not available at the moment.');
  };
  ...
  const features = [
    { icon: Shield, title: "Bank-Level Security", desc: "Military-grade encryption", color: "from-blue-500 to-cyan-500" },
    { icon: Zap, title: "Lightning Fast", desc: "Instant transactions", color: "from-yellow-500 to-orange-500" },
    { icon: Globe, title: "Global Access", desc: "Worldwide availability", color: "from-green-500 to-emerald-500" },
    { icon: Lock, title: "Secure Storage", desc: "Your keys, your crypto", color: "from-purple-500 to-pink-500" }
  ];
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Welcome back! Access your secure digital vault and manage your crypto portfolio with ease.
              </p>
            </motion.div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="text-white font-semibold text-lg">{features[currentFeature].title}</div>
                      <div className="text-gray-400">{features[currentFeature].desc}</div>
                    </div>
                  </div>
                </motion.div>
              </AnimatePresence>
                ...
                >
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-black/50 px-2 text-gray-400">Continue with</span>
                    </div>
                  </div>
